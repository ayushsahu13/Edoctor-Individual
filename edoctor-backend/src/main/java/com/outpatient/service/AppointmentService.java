...
public class AppointmentService {
    ...
    public Appointment scheduleAppointment(AppointmentRequest appointmentRequest) {
        ...
        emailService.sendAppointmentNotificationToPatient(savedAppointment);
        emailService.sendAppointmentNotificationToDoctor(savedAppointment);
...
//    }
    ...
    public Appointment confirmAppointment(Long appointmentId) {
        ...
        emailService.sendAppointmentStatusNotification(updatedAppointment, "Confirmed");
    ...
    public Appointment rejectAppointment(Long appointmentId) {
        ...
        emailService.sendAppointmentStatusNotification(updatedAppointment, "Rejected");
        return updatedAppointment;
    }
