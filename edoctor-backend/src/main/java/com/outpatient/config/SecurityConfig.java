    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admins/add").hasRole("ADMIN")
                        .requestMatchers("/api/admins/**").hasRole("ADMIN") // Restrict admin endpoints
                        ...
                        .requestMatchers("/api/admins/appointments/all").hasRole("ADMIN")
